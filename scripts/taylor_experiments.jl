...
#plt_vp_prob = plot_integ_poly_prob_vs_time(erf_space_region, integ_poly, sos_bound_poly, duration, n_points=50, geometric=false)
plt_vp_prob = plot_integ_poly_prob_vs_time(erf_space_region, integ_poly, ia_bound_poly, duration, n_points=50, geometric=false)
...
plt_vp_prob = plot_euler_mc_prob_vs_time(plt_vp_prob, erf_space_region, model, duration, n_points=50, n_samples=300)
